...
describe('Tabs', () => {
    ...
    describe('Keyboard Navigation', () => {
        ...
        it('should handle right arrow key navigation', () => {
            ...
            vi.spyOn(rightArrowEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should handle left arrow key navigation', () => {
            ...
            vi.spyOn(leftArrowEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should handle Home key navigation', () => {
            ...
            vi.spyOn(homeEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should handle End key navigation', () => {
            ...
            vi.spyOn(endEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should handle Space key activation', () => {
            ...
            vi.spyOn(spaceEvent, 'preventDefault').mockImplementation(() => {});
    ...
    describe('Scrollable Tabs', () => {
        ...
        it('should handle previous button click', () => {
            ...
            vi.spyOn(tabListComponent, 'onPrevButtonClick').mockImplementation(() => {});
        ...
        it('should handle next button click', () => {
            const tabListComponent = scrollableFixture.debugElement.query(By.directive(TabList)).componentInstance;
            vi.spyOn(tabListComponent, 'onNextButtonClick').mockImplementation(() => {});
